...
// ─────────────────────────────────────────────────────────────
//  Premium Typography Scale using Outfit (headings/titles) and Inter (body)
// ─────────────────────────────────────────────────────────────
val Typography = Typography(
    // ── Display (large splash text) ──
    ...
    // ── Title (list items, nav labels, dialpad digits) ──
    ...
    // ── Body (settings, descriptions, chat messages) ──
    bodyLarge = TextStyle(
    ...
    // ── Label (chips, badges, button text, tab labels) ──
